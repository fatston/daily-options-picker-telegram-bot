...
| `PICKS_CSV_FILE` | `./data/picks.csv` | Local CSV history for published picks. |
...
The optional `picks` array updates the local CSV. If it is omitted, the bot tries to extract picks from the message text.
